...
real,ALLOCATABLE,DIMENSION(:)::SUMVARS,MAXVARS            !VARIABLES FOR BOUNDS OF TROUBLED CELL INDICATOR
...
!$OMP THREADPRIVATE(TEMPFL,lamc,totalmm,invmm,TEMPFR,FLSTAR,FRSTAR,ULSTAR,UrSTAR,TEMPUL,TEMPUR,FL,eddyfl,eddyfr,FR,RML,RMR,NODES_LIST,VEXT,ELTYPE,ELEM_DEC,ELEM_LISTD,DETERJACS,JACS,INVERSEJACS,SOLUTION_INTEG2,LEFTV,RIGHTV,CORDS,VISCL,LAML,ETVM,TURBMV)
...
TYPE::QUADRATURE_POINTS_WEIGHTS
    REAL::X
    REAL::Y
    REAL::Z
    REAL::QP_WEIGHT
END TYPE QUADRATURE_POINTS_WEIGHTS

TYPE(QUADRATURE_POINTS_WEIGHTS),ALLOCATABLE,DIMENSION(:,:)::QP_ARRAY !CELL NUM, QP NUM
