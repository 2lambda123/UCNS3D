...
INTEGER::DG                     ! FLAG FOR DG DISCRETISATION
...
INTEGER::IDEGFREE,IMAX,INUM,IDEG,inump,INUMO,idegfree2,imax2,inum2,ideg2,inump2,inumo2,idegfree3		!DEGREES OF FREEDOM OF POLYNOMIAL IT WILL BECOME LOCA	L
...
REAL::INDICATOR_PAR1,INDICATOR_PAR2,INDICATOR_PAR3  !TROUBLED INDICATOR PARAMETERS
...
real,allocatable,dimension(:)::WEIGHTS_dg
!--------------------------------------------------------------------------------------------------------------------------!
!oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo!
...
!$OMP THREADPRIVATE(MP_SOURCE1,SUMVARS,MAXVARS,aver_vars,MP_SOURCE2,BASIS_VECTOR,tempsol,MP_SOURCE3,b_char,x_Char,INSTEN,llx,varcons,pointx,ba_char,a_char,ICONS_S,ICONS_E,compwrt,ILOCALALLELGD,ILOCALALLELG3,STCON,STCONC,STCONS,STCONG,COUNT_1,ISOSA,IX,IFSAT,WEIGHTS_dg,DG_RHS, DG_RHS_VOL_INTEG, DG_RHS_SURF_INTEG,IISTART,SHEARTEMP,IMAX,NUMBER_OF_NEI,b_code,INUM,angle1,angle2,IDEG,n_node,inump,INUMO,inumo2,ideg2,m2,inump2,imax2,A_ROT,C_ROT,B_ROT,ROOT_ROT,ANGLEFACEX,ANGLEFACEY,voltemp,VISCOTS,PHX,INTEG_MM)
...
REAL,ALLOCATABLE,DIMENSION(:)::MODAL_FILTER
...
REAL,ALLOCATABLE,DIMENSION(:)::DELTAF	!FLUXCHANGE
...
!$OMP THREADPRIVATE(TEMPFL,lamc,totalmm,invmm,TEMPFR,FLSTAR,FRSTAR,ULSTAR,UrSTAR,TEMPUL,TEMPUR,FL,eddyfl,eddyfr,FR,RML,RMR,NODES_LIST,VEXT,ELTYPE,ELEM_DEC,ELEM_LISTD,DETERJACS,JACS,INVERSEJACS,SOLUTION_INTEG2,LEFTV_DER,LEFTV,RIGHTV,CORDS,VISCL,LAML,ETVM,TURBMV)
...
REAL,ALLOCATABLE,DIMENSION(:)::FLUX_TERM_Z,FLUX_TERM_X,FLUX_TERM_Y
INTEGER::MODEU
REAL::VELNORMAL
...
real,allocatable,dimension(:,:)::R_dg,LSCQM_dg,INVRFF_dg,QTFF_dg,RFF_dg,QFF_dg
...
!$OMP THREADPRIVATE(NORMALVECT,DELTAF,VELNorMAL,MODEU,Q,R,QT,WEFF,MATRIX_A,LSQM,XCC,vgg,VELLSQMAT,MATRIX_SOLUTION,MATRIXFACE,JUSTCHECK,PDIM,XQR,VQR,VQR1,PQR,INVR,LSCQM,LSCQM2,ivgt,R_dg,LSCQM_dg,INVRFF_dg,QTFF_dg,RFF_dg,FLUX_TERM_Z,FLUX_TERM_X,FLUX_TERM_Y,QFF_dg)
...
TYPE LOCAL_RECON3
	...
	REAL,ALLOCATABLE,DIMENSION(:,:)::DG2FV
	...
	REAL,ALLOCATABLE,DIMENSION(:,:,:,:)::ULEFTV_DG ! (VAR, DIM, I_FACE, I_QP)
